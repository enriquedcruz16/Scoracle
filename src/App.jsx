    ...
    <div style={{minHeight:"100vh",background:"#000",display:"flex",alignItems:"center",justifyContent:"center",padding:20,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:1,background:"rgba(8,8,8,0.93)",border:"1px solid #252525",borderRadius:20,padding:"28px 24px",width:"100%",maxWidth:400,textAlign:"center"}}>
        ...
        {mode==="login"&&!resetSent&&(
          <button onClick={sendReset} disabled={load} style={{width:"100%",background:"none",border:"none",color:"#6b7280",fontSize:12,fontWeight:600,padding:"10px",cursor:"pointer",marginTop:4,outline:"none"}}>Forgot password?</button>
        )}
        {mode==="login"&&resetSent&&(
          <div style={{background:"rgba(34,197,94,0.08)",border:"1px solid rgba(34,197,94,0.2)",borderRadius:10,padding:"12px 14px",marginTop:8,textAlign:"center"}}>
            <div style={{fontSize:13,fontWeight:700,color:"#22c55e",marginBottom:4}}>Reset email sent!</div>
            <div style={{fontSize:11,color:"#6b7280"}}>Check your inbox and click the link to set a new password.</div>
          </div>
        )}
    ...
    <div style={{minHeight:"100vh",background:"#000",display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
      <div style={{width:"100%",maxWidth:380}}>
        <div style={{textAlign:"center",marginBottom:28}}>
          ...
          <div style={{fontSize:22,fontWeight:800,color:"#f59e0b",letterSpacing:2}}>SCORACLE</div>
          <div style={{fontSize:14,color:"#6b7280",marginTop:4}}>Set a new password</div>
        </div>
        {newPwDone
          ?<div style={{background:"rgba(34,197,94,0.08)",border:"1px solid rgba(34,197,94,0.2)",borderRadius:12,padding:20,textAlign:"center"}}>
            ...
            <div style={{fontSize:12,color:"#6b7280",marginTop:4}}>Taking you back to the app...</div>
          </div>
          :<div style={{background:"#0a0a0a",border:"1px solid #1a1a1a",borderRadius:16,padding:24}}>
            <label style={{display:"block",fontSize:11,fontWeight:700,color:"#555",letterSpacing:0.5,marginBottom:6,textTransform:"uppercase"}}>New Password</label>
            <input type="password" value={newPw} onChange={function(e){setNewPw(e.target.value);}} placeholder="Min 6 characters" style={{width:"100%",background:"#0f0f0f",border:"1px solid #1f1f1f",borderRadius:10,color:"#f9fafb",fontSize:15,padding:"12px 14px",outline:"none",boxSizing:"border-box",marginBottom:14}}/>
